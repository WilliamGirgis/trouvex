...
@Component({
  ...
  templateUrl: './save-item-lost-dialog.component.html',
  styleUrl: './save-item-lost-dialog.component.scss',
  providers: [provideNativeDateAdapter()],

  changeDetection: ChangeDetectionStrategy.Default
})
export class SaveItemLostDialogComponent implements OnInit {
  test(event:Event) {
    console.log(event)
    }
  imageList:any = []
  constructor(public lostObjectService:LostObjectService,public dialogRef:MatDialogRef<SaveItemLostDialogComponent>,@Inject(MAT_DIALOG_DATA) public data: {},private ngZone: NgZone) {
